...
[![PyPI version](https://img.shields.io/pypi/v/aospdtgenUI)](https://pypi.org/project/aospdtgenUI/)
...
This fork adds a GUI and support for generating device trees that work for both a ROM and a custom recovery simultaneously.
...
```
$ aospdtgenUI --help
usage: aospdtgenUI [-h] [-o OUTPUT] [--no-proprietary-files] [--dual-support]
                   [--ota-url OTA_URL] [--gui]
                   [dump_path]
...
options:
  ...
  --dual-support        Enable simultaneous ROM and Custom Recovery support
  --ota-url OTA_URL     OTA URL for the device
  --gui                 Launch the GUI
```
